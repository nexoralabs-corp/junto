...
const en = {
  ...
  modal: {
    ...
    confirm_remove_title: 'Remove expense?',
    confirm_remove_msg: 'This cannot be undone.',
...
const es: typeof en = {
  ...
  modal: {
    ...
    confirm_remove_title: '¿Eliminar gasto?',
    confirm_remove_msg: 'Esta acción no se puede deshacer.',
